...
import online.kyralo.amall.api.bo.TbCommodityAttrBO;
...
public class TbCommodityAttrServiceImpl implements TbCommodityAttrService {
    ...
    public Res<?> findById(String id) {
        ...
        if (tbCommodityAttrDO != null) {
            TbCommodityAttrBO tbCommodityAttr = new TbCommodityAttrBO();
            CopyUtil.copyBean(tbCommodityAttrDO, tbCommodityAttr);
    ...
    public Res<?> update(TbCommodityAttrModel tbCommodityAttrModel) {
        ...
        int i = tbCommodityAttrDAO.updateByPrimaryKeySelective(tbCommodityAttrDO);
